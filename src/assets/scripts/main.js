...
function setupEditor(editorFontSize) {
  ...
  require(["vs/editor/editor.main"], async function () {
    ...
    for (const key of ["Url", "Method", "Body", "Headers", "Cookies"]) {
      editorAddIntellisense(key, "Property", "Property for Request", key);
    }

    for (const key of ["StatusCode", "StatusMessage", "Success"]) {
      editorAddIntellisense(key, "Property", "Property for Response", key);
    }
